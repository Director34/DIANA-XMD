...
ezra({ 
    ...
    const img = 'https://files.catbox.moe/v1or1h.jpg';
    const imgs = 'https://files.catbox.moe/wh3gx1.jpg';
        ...
        await zk.sendMessage(dest, { 
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    title: "💕 𝐃𝐈𝐀𝐍𝐀 ~ 𝐗𝐌𝐃 💕",
                    body: "🔑🗝️ Command List",
                    thumbnailUrl: "https://files.catbox.moe/im8tu6.jpg",
