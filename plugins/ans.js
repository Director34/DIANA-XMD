...
ezra({nomCom:"diana",reaction:"🤷",categorie:"Official-IA"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  ezra({ nomCom: "bing4", reaction: "🌀", categorie: "Fredi-IA" }, async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      let caption = '*bing images by Diana Official 🌹*';
  ...
  ezra({ nomCom: "ai2", reaction: "🌀", categorie: "Diana-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
...
ezra({ nomCom: "gpt-all", reaction: "🌀", categorie: "Diana-IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
