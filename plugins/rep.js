...
ezra({
  ...
  const githubRepo = 'https://github.com/QUEEN-DIANA/DIANA-XMD';
  ...
  try {
    ...
    await zk.sendMessage(dest, {
      image: { url: 'https://files.catbox.moe/v1or1h.jpg' },
      caption: gitdata,
      contextInfo: {
        isForwarded: true,
        forwardedNewsletterMessageInfo: {
        ...
        forwardingScore: 999,
        externalAdReply: {
          title: "𝗗𝗜𝗔𝗡𝗔 𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟",
          body: "🫧 repo link request 🫧",
          thumbnailUrl: "https://files.catbox.moe/2rps71.jpg",
          mediaType: 1,
          sourceUrl: data.html_url || "https://github.com/QUEEN-DIANA/DIANA-XMD"
        }
      }
    });
